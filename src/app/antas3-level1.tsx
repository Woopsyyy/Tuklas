  ...
  return (
    <View className="flex-1 bg-black">
      ...
      <View className="flex-1">
        ...
        {/* Signpost Next */}
        <Animated.View entering={FadeIn.duration(600)} style={{ position: "absolute", left: signLeft - 0.03 * screenW + signW * 1.34, top: nextTop * 0.98 * 0.9, width: signW, height: nextH, zIndex: 25 }}>
        ...
        {/* Signpost Back */}
        <Animated.View entering={FadeIn.duration(600)} style={{ position: "absolute", left: signLeft - 0.03 * screenW + signW * 1.32, top: backTop * 1.02 * 0.9, width: signW * 0.95, height: backSignH * 0.95, zIndex: 25 }}>
