  ...
  return (
    <View className="flex-1 bg-black">
      ...
      <View className="flex-1">
        ...
        {/* Signpost Next */}
        <Animated.View entering={FadeIn.duration(600)} style={{ position: "absolute", left: signLeft - 0.03 * screenW + signW * 1.0, top: nextTop, width: signW, height: nextH, zIndex: 25 }}>
        ...
        {/* Signpost Back */}
        <Animated.View entering={FadeIn.duration(600)} style={{ position: "absolute", left: signLeft - 0.03 * screenW + signW * 1.0, top: backTop, width: signW * 0.95, height: backSignH * 0.95, zIndex: 25 }}>
