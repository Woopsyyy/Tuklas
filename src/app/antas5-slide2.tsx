...
export default function Antas5Slide2Screen() {
  ...
  const narration = useAudioPlayer(require("../../assets/audio/Isang araw.mp3"));
  ...
  const handleReplayNarration = async () => {
    try {
      ...
      console.warn("Antas5Slide2 narration replay error:", e);
    }
  };
  ...
  return (
    <View className="flex-1 bg-black">
      ...
      <View className="flex-1">
        ...
        {/* Next button â€” navigates to slide3 */}
        <Animated.View
          entering={FadeIn.duration(700)}
          style={{
            position: "absolute",
