...
export default function Antas1Level3Screen() {
  const router = useRouter();
  const soundEnabled = useSettingsStore((state) => state.soundEnabled);
  const toggleSound = useSettingsStore((state) => state.toggleSound);
  const { width, height } = useWindowDimensions();
  const insets = useSafeAreaInsets();
  const narration = useAudioPlayer(require("../../assets/audio/antas1 level3.mp3"));
  ...
  useFocusEffect(
    useCallback(() => {
      try {
        ...
        console.warn("Antas1Level3 narration setup error:", e);
      }
  ...
  const handlePlayNarration = () => {
    try {
      ...
      console.warn("Antas1Level3 narration play error:", e);
    }
  };
  ...
  return (
    <View className="flex-1 bg-black">
      ...
      <SafeAreaView className="flex-1" edges={["top", "bottom", "left", "right"]}>
        ...
        {/* Choice A Interactive Button (WRONG ANSWER) */}
        <Animated.View
        ...
        >
          <Image
            source={require("../../assets/images/antas1/question3/A.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            recyclingKey="antas1-q3-A"
            transition={0}
          />
        </Pressable>
        ...
        >
          <Image
            source={require("../../assets/images/antas1/question3/B.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            recyclingKey="antas1-q3-B"
            transition={0}
          />
        </Pressable>
        ...
        >
          <Image
            source={require("../../assets/images/antas1/question3/text2.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            recyclingKey="antas1-q3-text2"
            transition={0}
          />
        </View>
        ...
        >
          <Image
            source={require("../../assets/images/antas1/question3/text1.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            recyclingKey="antas1-q3-text1"
            transition={0}
          />
        </View>
      </SafeAreaView>
