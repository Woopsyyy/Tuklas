...
export default function Antas5Slide4Screen() {
  ...
  const handleReplayNarration = async () => {
    try {
      ...
      console.warn("Antas5Slide4 narration replay error:", e);
    }
  };
  ...
  return (
    <View className="flex-1 bg-black">
      ...
      <SafeAreaView className="flex-1" edges={["top", "bottom", "left", "right"]}>
        ...
        >
          <Image
            source={require("../../assets/images/antas5/slide4/sign.png")}
        ...
        >
          <Image
            source={require("../../assets/images/antas5/slide4/text1.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            transition={0}
          />
