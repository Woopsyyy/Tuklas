...
const insets = useSafeAreaInsets();
  ...
  const text1Top = bgOffsetY + 70 * bgScale + 0.05 * screenH + 0.02 * screenH;
  ...
  const nextTop = bgOffsetY + 630 * bgScale - 0.03 * screenH - 0.10 * screenH + 0.10 * screenH + 0.02 * screenH + 0.05 * screenH + 0.05 * screenH - 0.02 * screenH;
  const nextH = 92 * bgScale;
  const backTop = bgOffsetY + 735 * bgScale - 0.02 * screenH - 0.10 * screenH + 0.10 * screenH + 0.02 * screenH + 0.05 * screenH + 0.05 * screenH - 0.02 * screenH;
  ...
  useFocusEffect(
    useCallback(() => {
      try {
        ...
        console.warn("Antas2Level3 narration setup error:", e);
      }
...
{/* Full-screen Question Background */}
      ...
      <SafeAreaView className="flex-1" edges={["top", "bottom", "left", "right"]}>
        ...
        >
          <Image
            source={require("../../assets/images/antas2/question3/text1.png")}
        ...
        >
          <Image
            source={require("../../assets/images/antas2/question3/text2.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            transition={0}
          />
        ...
        >
          <Image
            source={require("../../assets/images/antas2/question3/A.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            transition={0}
          />
        ...
        >
          <Image
            source={require("../../assets/images/antas2/question3/B.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            transition={0}
          />
        ...
        <Animated.View
          ...
          style={[
            {
              position: "absolute",
              left: choiceBLeft + 0.27 * choiceW - (choiceW * 0.48 * 0.05) / 2 - (choiceW * 0.48 * 1.05 * 0.04) / 2 + 0.03 * choiceW,
              top: choiceTop + 0.18 * choiceH - (choiceH * 0.43 * 0.05) / 2,
              width: choiceW * 0.48 * 1.05 * 1.04,
              height: choiceH * 0.43 * 1.05,
              zIndex: 50,
            },
