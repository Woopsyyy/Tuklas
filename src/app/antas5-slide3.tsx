...
export default function Antas5Slide3Screen() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("Antas5Slide3 narration setup error:", e);
    }
    return () => {
      try {
        narration.pause();
        ...
        console.warn("Antas5Slide3 narration cleanup error:", e);
      }
    };
  ...
  useEffect(() => {
    try {
      ...
      console.warn("Antas5Slide3 narration mute error:", e);
    }
  ...
  return (
    <View className="flex-1 bg-black">
      ...
      <SafeAreaView className="flex-1" edges={["top", "bottom", "left", "right"]}>
        ...
        >
          <Pressable
            onPress={() => router.navigate("/antas5-slide4")}
            hitSlop={8}
