...
const choiceTop = (bgOffsetY + 310 * bgScale + 0.05 * screenH + 0.10 * screenH + 0.10 * screenH) * 0.8;
...
const text2W = Math.min(screenW * 0.88, 1280 * bgScale) * 2.25;
  ...
  const text2Top = (bgOffsetY + 860 * bgScale - 0.10 * screenH - 0.10 * screenH + 0.20 * screenH) * 0.7;
