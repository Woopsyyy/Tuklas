  ...
  useFocusEffect(
    useCallback(() => {
      try {
        ...
        console.warn("Antas2Level1 narration setup error:", e);
      }
...
{/* Full-screen Question Background (antas2/background.png) */}
      ...
      <SafeAreaView className="flex-1" edges={["top", "bottom", "left", "right"]}>
        ...
        >
          <Image
            source={require("../../assets/images/antas2/question1/text1.png")}
        ...
        >
          <Image
            source={require("../../assets/images/antas2/question1/text2.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            transition={0}
          />
        ...
        {/* Choice A Image & Interactive Frame (CORRECT ANSWER) */}
        ...
        >
          <Image
            source={require("../../assets/images/antas2/question1/A.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            transition={0}
          />
        ...
        {/* Choice B Image & Interactive Frame (WRONG ANSWER) */}
        {/* Render Image separately */}
        <Animated.View
          entering={FadeIn.duration(600).delay(250)}
          style={{
        ...
        >
          <Image
            source={require("../../assets/images/antas2/question1/B.png")}
            style={{ width: "100%", height: "100%" }}
            contentFit="contain"
            transition={0}
          />
        ...
        >
          <Pressable
            ...
            style={{
              ...
              height: "100%",
              borderRadius: 8 * bgScale,
              borderWidth: selectedChoice === "B" ? 4 : 0,
